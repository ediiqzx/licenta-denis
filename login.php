...
<div class="account-content">
  <form class="register">
    ...
    <input type="password" id="pass1" name="pass1" type="password" placeholder="Parola ta" required>
    <input type="password" id="pass2" name="pass2" type="password" placeholder="Confirmare parola" required>
